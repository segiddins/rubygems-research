...
class Version < ApplicationRecord
  ...
  has_one :package_blob, -> { excluding_contents }, class_name: "Blob", dependent: :destroy, inverse_of: :package_version, foreign_key: "sha256", primary_key: "sha256", strict_loading: true
